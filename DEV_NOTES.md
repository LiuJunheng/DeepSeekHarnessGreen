...
- **版本**：`GREEN_VERSION = 1.0.18`（launcher.py 内，唯一版本来源；`GREEN_VERSION_DATE` 打包当天自动回写）。GitHub + Gitee 双平台已发到 v1.0.18（2026-08-27：GitHub Release id=377549881 / Gitee Release id=908007，zip 17,717,720 B）。
