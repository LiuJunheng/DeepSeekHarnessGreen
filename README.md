...
> **下载**：GitHub [Release v1.0.13](https://github.com/LiuJunheng/DeepSeekHarnessGreen/releases/latest) ／ Gitee 镜像（国内更快）<https://gitee.com/liujunheng/DeepSeekHarnessGreen/releases> → 仓库 [GitHub](https://github.com/LiuJunheng/DeepSeekHarnessGreen) / [Gitee](https://gitee.com/liujunheng/DeepSeekHarnessGreen)
>
...
- **最新下载**（GitHub Release，tag `v1.0.13`）：<https://github.com/LiuJunheng/DeepSeekHarnessGreen/releases/latest>
...
- 分发 zip 命名约定：`DSH_Launcher_GreenPortable_Online_<日期>_v<版本>.zip`，Release tag 为 `v<版本>`（当前 `v1.0.13`）。
