...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const errorBadge = (errors) => {
			...
			return codes.map((c) =>
				react.createElement("span", {
					key: c,
					style: { fontSize: 11, color: "#c0392b", background: "#fdecea", borderRadius: 3, padding: "1px 6px", marginRight: 4 }
				}, c + "×" + errors[c])
			);
		};
		...
		function RewindSection({ getSessions }) {
			...
			const rootStyle = { display: "flex", flexDirection: "column", gap: 12, padding: 4, maxWidth: 780 };
			const titleStyle = { margin: 0, fontSize: 14, fontWeight: 600 };
			const descStyle = { margin: 0, fontSize: 13, lineHeight: 1.6, color: "#555" };
			const tableStyle = { border: "1px solid #ddd", borderRadius: 4, fontSize: 13, background: "#fff" };
			const thStyle = { textAlign: "left", padding: "6px 10px", background: "#f5f5f5", borderBottom: "1px solid #ddd", fontWeight: 600, fontSize: 12, color: "#444" };
			const tdStyle = { padding: "6px 10px", borderBottom: "1px solid #eee", verticalAlign: "top" };
			const btn = { padding: "4px 12px", cursor: "pointer", fontSize: 12 };
			...
			if (inspecting === null) {
				return react.createElement("div", { style: rootStyle },
					...
					Array.isArray(sessions) && react.createElement("div", { style: tableStyle },
						react.createElement("div", { style: { display: "flex", ...thStyle } },
							react.createElement("span", { style: { flex: 2 } }, "标题"),
							react.createElement("span", { style: { flex: 1 } }, "工作区"),
							react.createElement("span", { style: { flex: 1 } }, "创建时间"),
							react.createElement("span", { style: { width: 90 } }, "状态"),
							react.createElement("span", { style: { width: 120, textAlign: "right" } }, "操作")
						),
						sessions.length === 0 && react.createElement("div", { style: { padding: 10, color: "#888" } }, "没有找到任何会话。"),
						sessions.map((s) => react.createElement("div", { key: s.id, style: { display: "flex", alignItems: "center" } },
							react.createElement("span", { style: { flex: 2, ...tdStyle, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, title: s.id },
								s.title || "(无标题)",
								react.createElement("span", { style: { fontSize: 11, color: "#aaa", marginLeft: 6 } }, s.id.slice(0, 8) + "…")
							),
							react.createElement("span", { style: { flex: 1, ...tdStyle, fontSize: 12, color: "#666" } },
								(s.workspace && s.workspace.title) || s.workspaceKey || "—"
							),
							react.createElement("span", { style: { flex: 1, ...tdStyle, fontSize: 12, color: "#888" } }, fmtTime(s.createdAt)),
							react.createElement("span", { style: { width: 90, ...tdStyle, fontSize: 12 } },
								s.live ? react.createElement("span", { style: badgeLive }, "运行中") : react.createElement("span", { style: { color: "#999" } }, "空闲")
							),
							react.createElement("span", { style: { width: 120, ...tdStyle, textAlign: "right" } },
			...
			return react.createElement("div", { style: rootStyle },
				react.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } },
					...
					react.createElement("p", { style: { ...titleStyle, margin: 0 } },
						s && (s.title || "(无标题)"),
						react.createElement("span", { style: { fontSize: 11, color: "#aaa", marginLeft: 8 } }, s && s.id)
					)
				),
				...
				data !== null && react.createElement(react.Fragment, null,
					react.createElement("div", { style: { display: "flex", gap: 16, flexWrap: "wrap", fontSize: 13, color: "#555" } },
						...
						s && s.cwd && react.createElement("span", { style: { color: "#999" } }, s.cwd)
					),
					...
					react.createElement("div", { style: tableStyle },
						react.createElement("div", { style: { display: "flex", ...thStyle } },
							react.createElement("span", { style: { width: 70 } }, "回合"),
							react.createElement("span", { style: { flex: 3 } }, "用户问题 / 摘要"),
							react.createElement("span", { style: { width: 70 } }, "步骤"),
							react.createElement("span", { style: { width: 80 } }, "工具调用"),
							react.createElement("span", { style: { flex: 1 } }, "错误"),
							react.createElement("span", { style: { width: 110 } }, "状态"),
							react.createElement("span", { style: { width: 100, textAlign: "right" } }, "操作")
						),
						turns.length === 0 && react.createElement("div", { style: { padding: 10, color: "#888" } }, "该会话还没有任何回合。"),
						turns.map((t) => react.createElement("div", { key: t.turn, style: { display: "flex", alignItems: "center" } },
							react.createElement("span", { style: { width: 70, ...tdStyle, fontSize: 12 } }, "#" + t.turn),
							react.createElement("span", { style: { flex: 3, ...tdStyle, fontSize: 12, color: "#333", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, title: t.userText || "" },
								t.userText || "(无用户消息)"
							),
							react.createElement("span", { style: { width: 70, ...tdStyle, fontSize: 12 } }, t.steps),
							react.createElement("span", { style: { width: 80, ...tdStyle, fontSize: 12 } }, t.toolCalls),
							react.createElement("span", { style: { flex: 1, ...tdStyle } }, errorBadge(t.errors)),
							react.createElement("span", { style: { width: 110, ...tdStyle, fontSize: 12 } },
								t.complete
									? react.createElement("span", { style: { color: "#27ae60" } }, "已完成")
									: react.createElement("span", { style: { color: "#c0392b" } }, "未完成")
							),
							react.createElement("span", { style: { width: 100, ...tdStyle, textAlign: "right" } },
