    ...
    factory: (require) => {
        ...
        function MemoryCard() {
            ...
            return react.createElement("div", {
                style: {
                    ...
                    background: "linear-gradient(135deg, #1a1f3a 0%, #2d3358 100%)",
                    borderRadius: "12px",
                    color: "#e0e0e0",
                    minHeight: "400px",
                },
                ...
                react.createElement("div", { style: {
                    ...
                    react.createElement(StatBox, { label: "总条数", value: String(totalMem), color: "#a78bfa" }),
                ...
                status && react.createElement("div", { style: {
                    fontSize: "11px", color: "#8b95b8", marginBottom: "12px",
                ...
                error && react.createElement("div", { style: {
                    ...
                    borderLeft: "3px solid #ef4444", color: "#fca5a5", fontSize: "13px", marginBottom: "12px",
                }}, error),
                ...
                react.createElement("div", { style: { display: "flex", gap: "8px", marginBottom: "12px" }},
                    react.createElement("input", {
                        ...
                        style: {
                            ...
                            background: "rgba(255,255,255,0.08)", border: "1px solid #3a4068",
                ...
                react.createElement("div", { style: {
                    ...
                    borderTop: "1px solid #3a4068", paddingTop: "12px",
                }},
                    loading ? react.createElement("div", { style: { textAlign: "center", padding: "20px", color: "#8b95b8" } }, "加载中...")
                    : items.length === 0 ? react.createElement("div", { style: { textAlign: "center", padding: "20px", color: "#8b95b8" } }, "暂无记忆")
                    : items.map((item) =>
        ...
        function StatBox({ label, value, color }) {
            return react.createElement("div", { style: {
                ...
                react.createElement("div", { style: { fontSize: "11px", color: "#8b95b8", marginBottom: "2px" } }, label),
                react.createElement("div", { style: { fontSize: "16px", fontWeight: 600, color: color } }, value),
            );
        }
                ...
                react.createElement("div", { style: {
                    ...
                    tags.slice(0, 3).map((t, i) =>
                        react.createElement("span", {
                            key: i,
                            style: { padding: "1px 6px", borderRadius: "4px", background: "rgba(167, 139, 250, 0.2)", color: "#a78bfa" },
                        }, t)
                    ),
                    react.createElement("span", { style: { marginLeft: "auto", color: "#f59e0b" } }, `importance ${fmtImportance(item.importance)}`),
                    react.createElement("button", {
            ...
            return react.createElement("div", { style: {
                ...
                react.createElement("textarea", {
                    ...
                    style: {
                        ...
                        background: "rgba(0,0,0,0.2)", border: "1px solid #3a4068",
                        color: "#e0e0e0", fontSize: "13px", outline: "none", resize: "vertical",
